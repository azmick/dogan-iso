    ...
    >
      <div className="container-site flex flex-col gap-4 py-4 md:flex-row md:items-center md:justify-between md:gap-8">
        <p className="text-sm leading-relaxed text-text-muted">
          ...
          Detaylar için{' '}
          <Link href="/cerez-politikasi" className="font-semibold text-link underline underline-offset-2">
            Çerez Politikası
          </Link>{' '}
          ve{' '}
          <Link
        ...
        <div className="flex shrink-0 gap-3">
          <button type="button" onClick={() => decide('red')} className="btn btn-outline">
            Reddet
          </button>
          <button type="button" onClick={() => decide('kabul')} className="btn btn-primary">
            Kabul Et
          </button>
        </div>
      </div>
