...
export const projects = [
  {
    title: 'Bilgi Güvenliği Farkındalık Semineri',
    excerpt:
      'Kurumsal katılımcılara yönelik düzenlenen, oltalama senaryoları ve olay müdahalesi üzerine uygulamalı yarım günlük seminer.',
    daysAgo: 21,
    content: doc(
      p(
        'Seminerde bilgi güvenliği ihlallerinin insan kaynaklı boyutu ele alındı; katılımcılarla birlikte gerçek vakalardan uyarlanmış senaryolar üzerinde çalışıldı.',
      ),
      h('h2', 'Program Başlıkları'),
      ul([
        'Oltalama saldırılarının tanınması',
        'Parola yönetimi ve çok faktörlü doğrulama',
        'Şüpheli olay bildirimi ve müdahale akışı',
        'Uzaktan çalışmada veri güvenliği',
      ]),
    ),
  },
  {
    title: 'Üretim Sektöründe Entegre Yönetim Sistemi Projesi',
    excerpt:
      'Orta ölçekli bir üretim tesisinde ISO 9001, ISO 14001 ve ISO 45001 standartlarının tek sistem altında kurulması çalışması.',
    daysAgo: 54,
    content: doc(
      p(
        'Proje kapsamında üç standardın ortak maddeleri tek doküman setinde birleştirildi; standarda özgü gereklilikler ayrı ekler hâlinde yapılandırıldı.',
      ),
      h('h2', 'Proje Çıktıları'),
      ul([
        'Tek entegre el kitabı ve ortak prosedür seti',
        'Birleştirilmiş iç denetim programı',
        'Ortak risk ve fırsat değerlendirme metodolojisi',
        'Denetim gün sayısında belirgin azalma',
      ]),
    ),
  },
  {
    title: 'KVKK Uyum Çalıştayı',
    excerpt:
      'Farklı sektörlerden veri sorumlularının katıldığı, veri envanteri ve imha politikası üzerine uygulamalı çalıştay.',
    daysAgo: 96,
    content: doc(
      p(
        'Çalıştayda katılımcılar kendi kurumlarına ait örnek süreçler üzerinden veri envanteri taslağı hazırladı ve saklama sürelerini belirleme pratiği yaptı.',
      ),
      h('h2', 'Ele Alınan Konular'),
      ul([
        'Veri envanteri hazırlama metodolojisi',
        'Saklama süresi belirleme kriterleri',
        'Periyodik imha takvimi oluşturma',
        'İlgili kişi başvurularının yönetimi',
      ]),
    ),
  },
  {
    title: 'Yönetim Sistemleri Fuarı Katılımı',
    excerpt:
      'Sektör profesyonellerini bir araya getiren fuarda standımızda belgelendirme süreçleri hakkında bilgilendirme yaptık.',
    daysAgo: 140,
    content: doc(
      p(
        'Fuar boyunca ziyaretçilerle belgelendirme süreçleri, akreditasyon kapsamı ve denetim planlaması üzerine görüşmeler gerçekleştirildi.',
      ),
    ),
  },
]
